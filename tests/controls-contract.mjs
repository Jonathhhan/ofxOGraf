...
assert.match(htmlControls, /this\.shadowRoot\.addEventListener\("keydown", this\.onControlKey\)/);
assert.match(htmlControls, /this\.shadowRoot\.addEventListener\("keyup", this\.onControlKey\)/);
assert.match(htmlControls, /target\.select\(\)/);
